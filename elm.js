...
var $author$project$Main$GotBackendResponse = {$: 'GotBackendResponse'};
var $author$project$Main$SendingForm = {$: 'SendingForm'};
var $author$project$Main$SubmitSuccess = {$: 'SubmitSuccess'};
var $author$project$Main$form_Update = F2(
	function (field, form) {
		switch (field.$) {
			case 'Firstname':
				var str = field.a;
			...
			case 'FieldGotInput':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							form: A2($author$project$Main$form_Update, field, model.form)
						}),
					$elm$core$Platform$Cmd$none);
			case 'FormSubmitClicked':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{view: $author$project$Main$SendingForm}),
					A2(
						$elm$core$Task$perform,
...
var $author$project$Main$AgreeTerms = function (a) {
	return {$: 'AgreeTerms', a: a};
};
var $author$project$Main$ConfirmPassword = function (a) {
	return {$: 'ConfirmPassword', a: a};
};
var $author$project$Main$Email = function (a) {
	return {$: 'Email', a: a};
};
var $author$project$Main$FieldGotInput = function (a) {
	return {$: 'FieldGotInput', a: a};
};
var $author$project$Main$Firstname = function (a) {
	return {$: 'Firstname', a: a};
};
var $author$project$Main$FormSubmitClicked = {$: 'FormSubmitClicked'};
var $author$project$Main$Lastname = function (a) {
	return {$: 'Lastname', a: a};
};
...
var $author$project$Main$getPasswordError = function (password) {
	var uppercaseRegex = A2(
		$elm$core$Maybe$withDefault,
		$elm$regex$Regex$never,
		$elm$regex$Regex$fromString('[A-Z]'));
	var specialCharRegex = A2(
		$elm$core$Maybe$withDefault,
		$elm$regex$Regex$never,
		$elm$regex$Regex$fromString('[^a-zA-Z0-9]'));
	var hasUppercase = A2($elm$regex$Regex$contains, uppercaseRegex, password);
	var hasSpecialChar = A2($elm$regex$Regex$contains, specialCharRegex, password);
	var digitRegex = A2(
		$elm$core$Maybe$withDefault,
		$elm$regex$Regex$never,
		$elm$regex$Regex$fromString('[0-9]'));
	var hasDigit = A2($elm$regex$Regex$contains, digitRegex, password);
	return (password === '') ? $elm$core$Maybe$Nothing : (($elm$core$String$length(password) < 6) ? $elm$core$Maybe$Just('Password must be at least 6 characters') : ((!hasUppercase) ? $elm$core$Maybe$Just('Password must contain at least one uppercase letter') : ((!hasDigit) ? $elm$core$Maybe$Just('Password must contain at least one number') : ((!hasSpecialChar) ? $elm$core$Maybe$Just('Password must contain at least one special character') : $elm$core$Maybe$Nothing))));
};
var $elm$html$Html$h2 = _VirtualDom_node('h2');
var $elm$html$Html$input = _VirtualDom_node('input');
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$Main$isFormValid = function (form) {
	return (form.firstname !== '') && ((form.lastname !== '') && (_Utils_eq(
		$author$project$Main$getEmailError(form.email),
		$elm$core$Maybe$Nothing) && (_Utils_eq(
		$author$project$Main$getPasswordError(form.password),
		$elm$core$Maybe$Nothing) && (_Utils_eq(form.password, form.confirmPassword) && form.agreeTerms))));
};
...
var $author$project$Main$view_LabeledInput = function (_v0) {
	var label = _v0.label;
	var value = _v0.value;
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('labeled-input')
			]),
		_List_fromArray(
			[
...
var $author$project$Main$view_Hero = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('hero-text')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$text('Dolor eveniet mollitia omnis sequi obcaecati. Nobis sit nam iure sit earum. Dolorem natus dolore perspiciatis accusamus numquam maiores lorem!')
						]))
				]))
		]));
var $author$project$Main$view_Success = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$text('Thank you for registering!')
			]));
};
